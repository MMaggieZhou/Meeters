package com.example.meeters.view;
...
public class TimePicker extends LinearLayout
{
    ...
    private void init(Context mContext)
    {
        ...
        myPickerView = inflator.inflate(R.layout.tool_time_picker, null);
    ...
    private void initFilterNumericDigit()
    {
        ...
        try
        {
            if (currentTimeFormate == HOUR_12)
            {
                hour_display.setFilters(new InputFilter[] { new InputFilterMinMax(0, 11) });
            }
            else
            {
...
//            if (currentTimeFormate == HOUR_12)
//            {
//                mTimeWatcher.onTimeChanged(cal.get(Calendar.HOUR), cal.get(Calendar.MINUTE), cal.get(Calendar.AM_PM));
//            }
//            else
//            {
...
//            }
    ...
    public interface TimeWatcher
    {
        ...
        void onTimeChanged(Calendar cal);
